 ...
 * <p/>
 * Kilde: support/v7/appcompat/src/android/support/v7/internal/widget/ScrollingTabContainerView.java
 */
public class Skrald_ScrollingTabContainerView extends HorizontalScrollView
  ...
  private final boolean mAllowCollapse = false;
  ...
  public Skrald_ScrollingTabContainerView(Context context) {
    super(context);
  ...
  public Skrald_ScrollingTabContainerView(Context context, AttributeSet attrs) {
    super(context, attrs);
    mInflater = LayoutInflater.from(context);
    init(context);
  }
  ...
  public Skrald_ScrollingTabContainerView(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void init(Context context) {
    ...
    setContentHeight(32); //abp.getTabContainerHeight());
    //Log.d("TTTT abp.getTabContainerHeight()=" + abp.getTabContainerHeight());
    mStackedTabMaxWidth = 200;// abp.getStackedTabMaxWidth();
  ...
  private boolean performExpand() {
    //XXX setTabSelected(mTabSpinner.getSelectedItemPosition());
    return false;
  }
  ...
  private TabView createTabView(ActionBar.Tab tab, boolean forAdapter) {
    ...
    if (forAdapter) {
      ...
      tabView.setLayoutParams(new ListView.LayoutParams(ListView.LayoutParams.FILL_PARENT, mContentHeight));
    } else {
  ...
  public static class TabView extends LinearLayout {
    ...
    private Skrald_ScrollingTabContainerView mParent;

    public TabView(Context context, AttributeSet attrs) {
      super(context, attrs);
    }

    void attach(Skrald_ScrollingTabContainerView parent, ActionBar.Tab tab, boolean forList) {
      mParent = parent;
      mTab = tab;
