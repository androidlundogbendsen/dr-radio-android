...
public class FullPlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    contentUri = Uri.parse("http://drradio3-lh.akamaihd.net/i/p4ostjylland_9@143515/master.m3u8");//intent.getData();
    contentType = DemoUtil.TYPE_HLS_MASTER; // intent.getIntExtra(DemoUtil.CONTENT_TYPE_EXTRA, DemoUtil.TYPE_OTHER);
    contentId = "p4ostjylland_9"; //intent.getStringExtra(DemoUtil.CONTENT_ID_EXTRA);
