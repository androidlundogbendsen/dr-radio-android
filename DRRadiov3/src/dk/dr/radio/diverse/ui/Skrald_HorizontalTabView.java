 ...
 * Kilde: https://github.com/wordpress-mobile/WordPress-Android/blob/develop/src/org/wordpress/android/ui/HorizontalTabView.java
 * Licens: GPL
 */

public class Skrald_HorizontalTabView extends HorizontalScrollView implements OnClickListener {
  ...
  public Skrald_HorizontalTabView(Context context) {
    super(context);
    init();
  }

  public Skrald_HorizontalTabView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public Skrald_HorizontalTabView(Context context, AttributeSet attrs, int defStyle) {
  ...
  private void setupBackground() {
    setBackgroundColor(getResources().getColor(R.color.grå10));
  }
  ...
  public void addTab(Tab tab) {
    ...
    int divWidth = 2; //(int) Utils.dpToPx(1);
    int divTopMargin = 24;//(int) Utils.dpToPx(12);
    int divHeight = 48;//(int) Utils.dpToPx(24);

    int tabPad = 32;//(int) Utils.dpToPx(16);
    ...
    if (mTextViews.size() > 0) {
      ...
      divider.setBackgroundColor(getResources().getColor(R.color.sort));
    ...
    textView.setTextColor(getResources().getColor(R.color.grå60));
    ...
    //XXX linearLayout.setBackgroundResource(R.drawable.tab_indicator_ab_wordpress);
